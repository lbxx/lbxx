	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				url : "${ctx}/technicianLeave/listgrid",
				datatype : "json",
				//height: 250,
			...
			function formatName(cellvalue, options, rowdata) {
				...
				if (cellvalue == technicians[i].id){
				    return technicians[i].name;					
				    }
				}
			}
						...
						function() {
							...
							if (selectedIds == undefined
								...
								if (selectedIds.length <= 0) {
									...
									location.href = "${ctx}/technicianLeave/add?technicianleaveid="
											+ selectedIds[0];
								}
							}
						});
				...
				function() {
					...
					if (selectedIds == undefined || selectedIds.length == 0) {
						...
						if (selectedIds.length <= 0) {
							...
							var url = '${ctx}/technicianLeave/remove' + "?id="
									+ selectedIds[0];
