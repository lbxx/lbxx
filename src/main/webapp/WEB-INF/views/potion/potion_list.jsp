        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-2 tn aol"><input type="text" id="name" placeholder="" class="confS_input pg_input"></span>
                        </div>
    ...
    jQuery(function($) {
        ...
        $("#searchBtn").click(function(){
            ...
            $("#grid-table").jqGrid('setGridParam',{  // grid-table 这个是表格的id, setGridParam这个值是固定值
                url:"${ctx}/potion/queryList", // 请求url
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colModel:[
                ...
                {name:'pic',index:'pic', width:150,editable: true},
                {name:'detail',index:'detail', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
