				...
				<ul class="nav ace-nav">
					...
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							...
							<li><a href="#"> <img
									src="${ctx}/resources/avatars/avatar.png" class="msg-photo"
							...
							<li><a href="#"> <img
									src="${ctx}/resources/avatars/avatar3.png" class="msg-photo"
							...
							<li><a href="#"> <img
									src="${ctx}/resources/avatars/avatar4.png" class="msg-photo"
