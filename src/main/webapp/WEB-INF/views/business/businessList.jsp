...
<body>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			//格式化性别
			function formatCategory(cellvalue, options, rowdata) {
				for(i in categorys){
				if (cellvalue == categorys[i].id){
						...
						function() {
							...
							if (selectedIds == undefined
								...
								if (selectedIds.length <= 0) {
									...
									location.href = "${ctx}/business/add?businessid="
											+ selectedIds[0];
								}
							}
						});
				...
				function() {
					...
					if (selectedIds == undefined || selectedIds.length == 0) {
						...
						if (selectedIds.length <= 0) {
							...
							var url = '${ctx}/business/remove' + "?id="
									+ selectedIds[0];
