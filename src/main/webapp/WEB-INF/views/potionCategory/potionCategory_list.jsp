        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-2 tn aol"><input type="text" id="name" name="name" placeholder="请输入类型名" class="confS_input pg_input"></span>
                        </div>
    ...
    jQuery(function($) {
        ...
        $("#searchBtn").click(function(){
            ...
            $("#grid-table").jqGrid('setGridParam',{  // grid-table 这个是表格的id, setGridParam这个值是固定值
                url:"${ctx}/potionCategory/queryList", // 请求url
        ...
        jQuery(grid_selector).jqGrid({
            url: "${ctx}/potionCategory/queryList",
            datatype: "json",
            //height: 250,
