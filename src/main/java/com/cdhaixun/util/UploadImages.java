...
public class UploadImages {  
     ...
     * @since  1.0.0 
     */  
    public static String upLoadImage(HttpServletRequest request,MultipartFile image,String path1,String path2){  
        ...
        fileTypes.add("svg");  
                ...
                if (!(image.getOriginalFilename() == null || "".equals(image  
                     ...
                     */  
                    File file = new UploadImages().getFile(image, path1, path3, fileTypes);  
