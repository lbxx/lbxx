...
public class APITest {
	...
	public static final String USER = "xxxxxxxxxx";//*必填*：账号名
	public static final String UKEY = "xxxxxxxxxxx";//*必填*: 注册账号后生成的UKEY
	public static final String SN = "xxxxxxxxx";//*必填*：打印机编号，必须要在管理后台里添加打印机之后，才能调用API
